      ...
      <Routes>
        ...
        <Route path="/auth-login" element={<RotaPrivada />}>
          ...
          <Route path="/auth-login/auth-gerente" element={<RotaGerente />}>
            <Route path="/auth-login/auth-gerente/dashboard" element={<Dashboard />} />
            <Route path="/auth-login/auth-gerente/produtos" element={<Produtos />} />
            <Route path="/auth-login/auth-gerente/banner" element={<Banner />} />

            <Route path="/auth-login/auth-gerente/auth-adm" element={<RotaAdm />}>
              <Route path="/auth-login/auth-gerente/auth-adm/fornecedores" element={<Fornecedores />} />
              <Route path="/auth-login/auth-gerente/auth-adm/usuariosSistema" element={<UsuariosSistema />} />
            </Route>
          </Route>
        </Route>
